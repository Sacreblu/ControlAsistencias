...
<link rel="stylesheet" href="{{asset('css/Admin/Materias/ModificarMaterias.css')}}">
<script src="{{asset('js/Admin/Materias/ModificarMateria.js')}}" type="text/javascript"></script>
        ...
        <div class="row">
            <div class="col-md-6 divRegMateria row">
                ...
                <div class="col-md-10 divFormRegMateria">
                   <legend class="titulos">Modificar Experiencia Educativa</legend>
                    <form id="formModMateria" class="formModMateria" action="" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="EE" name="EE" oninput="$('#alertEEModificar').html('')">
                            <input type="hidden" id="idEE" name="idEE"8>
                        ...
                        <div id="" class="row" >
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="NRC" name="NRC" oninput="$('#alertNRCModificar').html('')">
                                <span class="alertError" id="alertNRCModificar"></span>
                            </div>
                        </div><br>
                        ...
                        <div id="" class="row" >
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input  type="number" oninput="$('#alertSeccionModificar').html(''); if( this.value.length > 1 )  this.value = this.value.slice(0,1)" class="form-control" id="Seccion" name="Seccion">
                                <span class="alertError" id="alertSeccionModificar"></span>
                            </div>
                        </div><br>

                        <div class="form-group">
                            <label for="Profesor" class="label">Docente</label>
                            <input type="text" class="form-control" id="Profesor" name="Profesor" oninput="$('#alertidProfesorModificar').html('')" onchange="ControladorProfesor()">
                            <input type="hidden" name="idProfesor" id="idProfesor">
                            <span class="alertError" id="alertidProfesorModificar"></span>
                            <span class="alertError" id="alertProfesorModificar"></span>
                        </div><br>
                    </form>
                    <button type="button" onclick="EjecutarValidaciones()" class="btn btn-success" style="align-self:center" id="btnGuardar" >Guardar Cambios</button>
                </div>
            </div>
            <div class="col-md-6 divRegClases row">
               
               <div class="col-md-10 divFormulariosRegClases">
                   <legend class="titulos">Modificar Horarios</legend>
